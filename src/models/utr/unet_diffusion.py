...
from diffusers.models.unets.unet_1d import UNet1DModel, DDPMScheduler, DDIMScheduler
...
sweep_config = {
    ...
    'parameters': {
        ...
        'down_block_types': {
            'values': [["DownBlock1D", "AttnDownBlock1D", "DownBlock1D"], ["DownBlock1dNoSkip", "DownBlock1D", "AttnDownBlock1D"], ["DownBlock1D", "DownBlock1D", "DownBlock1D"], ['AttnDownBlock1D', "AttnDownBlock1D", "AttnDownBlock1D"], ["DownBlock1D", "DownBlock1D", "AttnDownBlock1D"]]
        },
        'up_block_types': {
            'values': [["UpBlock1D", "AttnUpBlock1D", "UpBlock1D"], ["AttnUpBlock1D", "UpBlock1D", "UpBlock1DNoSkip"], ["UpBlock1D", "UpBlock1D", "UpBlock1D"], ['AttnUpBlock1D', "AttnUpBlock1D", "AttnUpBlock1D"], ["AttnUpBlock1D", "UpBlock1D", "UpBlock1D"]]
        },
        'device' : {
...
wandb.init(
    project = "5utr-diffusion-parallel",
    config = config
)
